...
int main(void)
{
	...
	/* Issue a Command Complete with NOP to signal the host that the
	 * controller is ready.  The host should have CONFIG_BT_WAIT_NOP=y
	 * so it waits for this event before sending HCI Reset.
	 */
	{
		int i;
